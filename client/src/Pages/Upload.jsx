            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="mb-8">
                <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-xs sm:text-sm mb-2">
                  <span className="text-gray-600 whitespace-nowrap">1. Personal Info</span>
                  <span className="text-gray-600 whitespace-nowrap">2. Education</span>
                  <span className="text-gray-600 whitespace-nowrap">3. Skills</span>
                  <span className="text-blue-500 font-medium whitespace-nowrap">4. Uploads</span>
